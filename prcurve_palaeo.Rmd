...
```{r legendre-data-plot, echo=FALSE, cache=TRUE, dependson='legendre-data', fig.height=7, fig.width=7, fig.cap="\\label{legendre-data-fig}"}
op <- par(mar = c(4,4,0.5,2) + 0.1)
...
```{r iterations-prcurve, echo=FALSE, results='hide', dependson="comparison-figure"}
...
plot(f1, d.s, cex = CEX)
lines(f0, d.s, segments = FALSE, col = prevCol, lwd.curve = 1)
lines(f1, d.s, segments = FALSE)
title(sub = "Iteration: 1")
plot(f4, d.s, cex = CEX)
lines(f0, d.s, segments = FALSE, col = prevCol, lwd.curve = 1)
lines(f1, d.s, segments = FALSE, col = prevCol, lwd.curve = 1)
lines(f4, d.s, segments = FALSE)
title(sub = "Iteration: 4")
plot(f12, d.s, cex = CEX)
lines(f0, d.s, segments = FALSE, col = prevCol, lwd.curve = 1)
lines(f1, d.s, segments = FALSE, col = prevCol, lwd.curve = 1)
lines(f4, d.s, segments = FALSE, col = prevCol, lwd.curve = 1)
lines(f12, d.s, segments = FALSE)
