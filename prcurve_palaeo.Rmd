...
plot(f1, d.s, cex = CEX)
lines(f0, d.s, segments = FALSE, col = prevCol, lwd = 1)
lines(f1, d.s, segments = FALSE)
title(sub = "Iteration: 1")
plot(f4, d.s, cex = CEX)
lines(f0, d.s, segments = FALSE, col = prevCol, lwd = 1)
lines(f1, d.s, segments = FALSE, col = prevCol, lwd = 1)
lines(f4, d.s, segments = FALSE)
title(sub = "Iteration: 4")
plot(f12, d.s, cex = CEX)
lines(f0, d.s, segments = FALSE, col = prevCol, lwd = 1)
lines(f1, d.s, segments = FALSE, col = prevCol, lwd = 1)
lines(f4, d.s, segments = FALSE, col = prevCol, lwd = 1)
